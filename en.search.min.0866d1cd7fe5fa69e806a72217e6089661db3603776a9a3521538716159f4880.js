...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/blog/flexsearch.min.js');loadScript('/blog/en.search-data.min.a1e75d4d4ecfede4d9d120d0b5a653cbcbc6f177ef75f0059f032e645f01da93.js',function(){input.required=false;search();});}
